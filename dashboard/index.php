    ...
    <div class="modal-dialog modal-lg" role="document">
      <div class="modal-content text-center col-md-10 mb-5">
        ...
        <div class="modal-body text-center d-flex flex-column">
          ...
          <button class="col-12 mt-3 btn btn-dark" onclick="copyLinkToClipboard()"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-share" viewBox="0 0 16 16">
